package com.jeeopen.web.tags.form.support;

import com.jeeopen.common.utils.ObjectUtils;
import com.jeeopen.common.utils.Reflections;
...
public class FreemarkerFormTagHelper {
	...
	public Map<String, Object> initFreeMarkerMap(Object tag, Context pageContext) {
		...
		if (env != null){
			staticPath = env.getProperty("jeeopen.staticPath");
			adminPath = env.getProperty("jeeopen.admin.url.prefix");
		}
		rootMap.put("ctx", ctx);
