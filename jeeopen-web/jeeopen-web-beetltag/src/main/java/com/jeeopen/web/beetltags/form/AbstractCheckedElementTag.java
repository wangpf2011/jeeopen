...
public abstract class AbstractCheckedElementTag extends AbstractHtmlInputElementTag {
	 ...
	 * through delegating to {@link com.jeeopen.web.beetltags.form.SelectedValueComparator#isSelected}.
	 */
	private boolean isOptionSelected(Object value) throws BeetlTagException {
		return com.jeeopen.web.beetltags.form.SelectedValueComparator.isSelected(getBindStatus(), value);
	}
