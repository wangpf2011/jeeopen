...
import com.jeeopen.web.beetltags.form.ValueFormatter;
...
abstract class SelectedValueComparator {
	...
	private static boolean exhaustiveCompare(Object boundValue, Object candidate,
		...
		String candidateDisplayString = com.jeeopen.web.beetltags.form.ValueFormatter.getDisplayString(candidate, editor, false);
