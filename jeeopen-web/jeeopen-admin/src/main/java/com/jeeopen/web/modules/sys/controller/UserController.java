...
import com.jeeopen.common.http.ValidResponse;
...
import com.jeeopen.web.modules.sys.entity.*;
import com.jeeopen.web.modules.sys.service.*;
...
@RestController
@RequestMapping("${jeeopen.admin.url.prefix}/sys/user")
