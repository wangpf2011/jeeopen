package com.jeeopen.common.security.shiro.session;

import com.google.common.collect.Sets;
import com.jeeopen.common.utils.DateUtils;
import com.jeeopen.common.utils.JedisUtils;
...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO {
	...
	public void update(Session session) throws UnknownSessionException {
		 ...
		 * JeeOpenPropertiesUtil.getConfig("web.view.prefix")) &&
		 * StringUtils.endsWith(uri,
		 * JeeOpenPropertiesUtil.getConfig("web.view.suffix"))) { return; } //
		 * 手动控制不更新SESSION if
